 ...
 *
 *   GET    /api/workspace/snippets        — anyone signed in
 *   POST   /api/workspace/snippets        — snippets:manage
 *   PATCH  /api/workspace/snippets/:id    — snippets:manage
 *   DELETE /api/workspace/snippets/:id    — snippets:manage
 *
 ...
 */
@Controller("api/workspace/snippets")
