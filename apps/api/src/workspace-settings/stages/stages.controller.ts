 ...
 *
 *   GET    /api/workspace/stages              — anyone signed in
 *   POST   /api/workspace/stages              — admin / manager / superAdmin
 *   PATCH  /api/workspace/stages/:id          — admin / manager / superAdmin
 *   DELETE /api/workspace/stages/:id          — admin / manager / superAdmin
 *   PATCH  /api/workspace/stages/reorder      — admin / manager / superAdmin
 *
 ...
 */
@Controller("api/workspace/stages")
