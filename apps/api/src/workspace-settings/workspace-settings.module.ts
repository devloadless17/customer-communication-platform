...
import { WorkspaceRootController } from "./workspace-root.controller";
...
/**
 * Aggregates the `/api/workspace/*` catalog routes. Each sub-module owns a
...
@Module({
  ...
  controllers: [WorkspaceRootController],
  providers: [WorkspaceRootService],
  exports: [WorkspaceRootService],
})
