 ...
 *
 *   GET    /api/workspace/webchatwidget      — list the team's widgets
 *   POST   /api/workspace/webchatwidget      — create one (mints a public site key)
 *   PATCH  /api/workspace/webchatwidget/:id  — rename / re-theme / toggle active
 *   DELETE /api/workspace/webchatwidget/:id  — delete (conversations keep their history)
 */
@Controller("api/workspace/webchatwidget")
@RequireRole("admin")
