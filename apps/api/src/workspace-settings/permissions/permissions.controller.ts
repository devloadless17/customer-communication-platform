 ...
 *
 *   GET   /api/workspace/permissions   — any signed-in member; returns the EFFECTIVE
 ...
 *   PATCH /api/workspace/permissions   — admin only; persists overrides for the
 ...
 */
@Controller("api/workspace/permissions")
