 ...
 *
 *   GET    /api/team/message-flags          — anyone signed in (live only)
 *   GET    /api/team/message-flags/usage    — messageFlags:manage (settings)
 *   POST   /api/team/message-flags          — messageFlags:manage
 *   PATCH  /api/team/message-flags/:id      — messageFlags:manage
 *   DELETE /api/team/message-flags/:id      — messageFlags:manage
 */
@Controller("api/team/message-flags")
